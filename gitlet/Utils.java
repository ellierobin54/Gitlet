...
class Utils {
    ...
    /** Write the entire contents of BYTES to FILE, creating or
        overwriting it as needed. Throws IllegalArgumentException \
        in case of problems. */
    ...
    /** Wirte the entire conetns of Object into File.
     * @param file file of the object
     * @param contents object of the conentes
     */
    ...
    /** return the byte of the commit object.
     * @param obj object that will serialized
        ...
        try {
            ...
            throw new
                    IllegalArgumentException(
                            "Internal error serializing commit.");
        }
    }
    ...
    /** Returns the Stirng of the stirng.
     * @param name name of file*/
    static String stringIn(String name) {
        try {
